...
void encode_test_034(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 034\nInput: %s\n", diag);
    len += cbor_set_string(buffer + len, sizeof(buffer) - len, "");
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_035(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 035\nInput: %s\n", diag);
    len += cbor_set_string(buffer + len, sizeof(buffer) - len, "a");
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_036(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 036\nInput: %s\n", diag);
    len += cbor_set_string(buffer + len, sizeof(buffer) - len, "IETF");
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_038(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 038\nInput: %s\n", diag);
    len += cbor_set_string(buffer + len, sizeof(buffer) - len, "ü");
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_039(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 039\nInput: %s\n", diag);
    len += cbor_set_string(buffer + len, sizeof(buffer) - len, "水");
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_040(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 040\nInput: %s\n", diag);
    len += cbor_set_string(buffer + len, sizeof(buffer) - len, "𐅑");
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_046(void) {
    ...
    len += cbor_set_string(buffer + len, sizeof(buffer) - len, "a");
    len += cbor_set_int(buffer + len, sizeof(buffer) - len, 1);
    len += cbor_set_string(buffer + len, sizeof(buffer) - len, "b");
    len += cbor_begin_definite_array(buffer + len, sizeof(buffer) - len, 2);
    len += cbor_set_int(buffer + len, sizeof(buffer) - len, 2);
    len += cbor_set_int(buffer + len, sizeof(buffer) - len, 3);
    printf("Expecting: ");
...
void encode_test_047(void) {
    ...
    len += cbor_set_string(buffer + len, sizeof(buffer) - len, "b");
    len += cbor_set_string(buffer + len, sizeof(buffer) - len, "c");
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_048(void) {
    ...
    len += cbor_set_string(buffer + len, sizeof(buffer) - len, "c");
    len += cbor_set_string(buffer + len, sizeof(buffer) - len, "C");
    len += cbor_set_string(buffer + len, sizeof(buffer) - len, "d");
    len += cbor_set_string(buffer + len, sizeof(buffer) - len, "D");
    len += cbor_set_string(buffer + len, sizeof(buffer) - len, "e");
    len += cbor_set_string(buffer + len, sizeof(buffer) - len, "E");
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
