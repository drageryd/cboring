...
void encode_test_000(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 000\nInput: %s\n", diag);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 0);
    printf("Expecting: ");
...
void encode_test_001(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 001\nInput: %s\n", diag);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 1);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_002(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 002\nInput: %s\n", diag);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 10);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_003(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 003\nInput: %s\n", diag);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 23);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_004(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 004\nInput: %s\n", diag);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 24);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_005(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 005\nInput: %s\n", diag);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 25);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_006(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 006\nInput: %s\n", diag);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 100);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_007(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 007\nInput: %s\n", diag);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 1000);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_008(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 008\nInput: %s\n", diag);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 1000000);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_009(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 009\nInput: %s\n", diag);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 1000000000000);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_010(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 010\nInput: %s\n", diag);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 9223372036854775807);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_011(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 011\nInput: %s\n", diag);
    len += cboring_set_null(buffer + len, sizeof(buffer) - len);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_018(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 018\nInput: %s\n", diag);
    len += cboring_set_float(buffer + len, sizeof(buffer) - len, 0.0);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_020(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 020\nInput: %s\n", diag);
    len += cboring_set_float(buffer + len, sizeof(buffer) - len, 1.0);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_021(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 021\nInput: %s\n", diag);
    len += cboring_set_double(buffer + len, sizeof(buffer) - len, 1.1);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_022(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 022\nInput: %s\n", diag);
    len += cboring_set_float(buffer + len, sizeof(buffer) - len, 1.5);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_023(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 023\nInput: %s\n", diag);
    len += cboring_set_float(buffer + len, sizeof(buffer) - len, 65504.0);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_024(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 024\nInput: %s\n", diag);
    len += cboring_set_float(buffer + len, sizeof(buffer) - len, 100000.0);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_025(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 025\nInput: %s\n", diag);
    len += cboring_set_float(buffer + len, sizeof(buffer) - len, 3.4028234663852886e+38);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_026(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 026\nInput: %s\n", diag);
    len += cboring_set_double(buffer + len, sizeof(buffer) - len, 1e+300);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_027(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 027\nInput: %s\n", diag);
    len += cboring_set_float(buffer + len, sizeof(buffer) - len, 5.960464477539063e-08);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_028(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 028\nInput: %s\n", diag);
    len += cboring_set_float(buffer + len, sizeof(buffer) - len, 6.103515625e-05);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_029(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 029\nInput: %s\n", diag);
    len += cboring_set_float(buffer + len, sizeof(buffer) - len, -4.0);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_030(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 030\nInput: %s\n", diag);
    len += cboring_set_double(buffer + len, sizeof(buffer) - len, -4.1);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_031(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 031\nInput: %s\n", diag);
    len += cboring_set_bool(buffer + len, sizeof(buffer) - len, false);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_032(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 032\nInput: %s\n", diag);
    len += cboring_set_bool(buffer + len, sizeof(buffer) - len, true);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_034(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 034\nInput: %s\n", diag);
    len += cboring_set_text_string(buffer + len, sizeof(buffer) - len, "");
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_035(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 035\nInput: %s\n", diag);
    len += cboring_set_text_string(buffer + len, sizeof(buffer) - len, "a");
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_036(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 036\nInput: %s\n", diag);
    len += cboring_set_text_string(buffer + len, sizeof(buffer) - len, "IETF");
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_038(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 038\nInput: %s\n", diag);
    len += cboring_set_text_string(buffer + len, sizeof(buffer) - len, "ü");
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_039(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 039\nInput: %s\n", diag);
    len += cboring_set_text_string(buffer + len, sizeof(buffer) - len, "水");
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_040(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 040\nInput: %s\n", diag);
    len += cboring_set_text_string(buffer + len, sizeof(buffer) - len, "𐅑");
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_041(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 041\nInput: %s\n", diag);
    len += cboring_begin_definite_array(buffer + len, sizeof(buffer) - len, 0);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_042(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 042\nInput: %s\n", diag);
    len += cboring_begin_definite_array(buffer + len, sizeof(buffer) - len, 3);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 1);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 2);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 3);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_043(void) {
    ...
    len += cboring_begin_definite_array(buffer + len, sizeof(buffer) - len, 3);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 1);
    len += cboring_begin_definite_array(buffer + len, sizeof(buffer) - len, 2);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 2);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 3);
    len += cboring_begin_definite_array(buffer + len, sizeof(buffer) - len, 2);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 4);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 5);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_044(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 044\nInput: %s\n", diag);
    len += cboring_begin_definite_array(buffer + len, sizeof(buffer) - len, 25);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 1);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 2);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 3);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 4);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 5);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 6);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 7);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 8);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 9);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 10);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 11);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 12);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 13);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 14);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 15);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 16);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 17);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 18);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 19);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 20);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 21);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 22);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 23);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 24);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 25);
    printf("Expecting: ");
...
void encode_test_045(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 045\nInput: %s\n", diag);
    len += cboring_begin_definite_map(buffer + len, sizeof(buffer) - len, 0);
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_046(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 046\nInput: %s\n", diag);
    len += cboring_begin_definite_map(buffer + len, sizeof(buffer) - len, 2);
    len += cboring_set_text_string(buffer + len, sizeof(buffer) - len, "a");
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 1);
    len += cboring_set_text_string(buffer + len, sizeof(buffer) - len, "b");
    len += cboring_begin_definite_array(buffer + len, sizeof(buffer) - len, 2);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 2);
    len += cboring_set_int(buffer + len, sizeof(buffer) - len, 3);
    printf("Expecting: ");
...
void encode_test_047(void) {
    ...
    len += cboring_begin_definite_array(buffer + len, sizeof(buffer) - len, 2);
    len += cboring_set_text_string(buffer + len, sizeof(buffer) - len, "a");
    len += cboring_begin_definite_map(buffer + len, sizeof(buffer) - len, 1);
    len += cboring_set_text_string(buffer + len, sizeof(buffer) - len, "b");
    len += cboring_set_text_string(buffer + len, sizeof(buffer) - len, "c");
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
    print_buffer(buffer, sizeof(buffer));
...
void encode_test_048(void) {
    ...
    size_t len = 0;
    printf("\nEncode test 048\nInput: %s\n", diag);
    len += cboring_begin_definite_map(buffer + len, sizeof(buffer) - len, 5);
    len += cboring_set_text_string(buffer + len, sizeof(buffer) - len, "a");
    len += cboring_set_text_string(buffer + len, sizeof(buffer) - len, "A");
    len += cboring_set_text_string(buffer + len, sizeof(buffer) - len, "b");
    len += cboring_set_text_string(buffer + len, sizeof(buffer) - len, "B");
    len += cboring_set_text_string(buffer + len, sizeof(buffer) - len, "c");
    len += cboring_set_text_string(buffer + len, sizeof(buffer) - len, "C");
    len += cboring_set_text_string(buffer + len, sizeof(buffer) - len, "d");
    len += cboring_set_text_string(buffer + len, sizeof(buffer) - len, "D");
    len += cboring_set_text_string(buffer + len, sizeof(buffer) - len, "e");
    len += cboring_set_text_string(buffer + len, sizeof(buffer) - len, "E");
    printf("Expecting: ");
    print_buffer(hex, sizeof(hex));
    printf("\nEncoded  : ");
